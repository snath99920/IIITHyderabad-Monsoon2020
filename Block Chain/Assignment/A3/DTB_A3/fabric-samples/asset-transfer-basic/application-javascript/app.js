...
async function main() {
	try {
		...
		try {
			...
			await contract.submitTransaction('CreateAsset', 'asset12', 'Bob', '150');
        	await contract.submitTransaction('ReadAsset', 'asset12');
			console.log('Your Bid has been submitted');
			
			console.log('\n--> Evaluate Transaction: GetAllAssets, function returns all the current assets on the ledger');
			let result1 = await contract.evaluateTransaction('GetAllAssets');
			console.log(`*** Result: ${prettyJSONString(result1.toString())}`);


        	await contract.submitTransaction('CreateAsset', 'asset23', 'Alice', '290');
        	await contract.submitTransaction('ReadAsset', 'asset23');
			console.log('Your Bid has been submitted');
        	...
        	await contract.submitTransaction('CreateAsset', 'asset53', 'Jack', '100');
        	await contract.submitTransaction('ReadAsset', 'asset53');
			console.log('Your Bid has been submitted');
			
			console.log('\n--> Evaluate Transaction: GetAllAssets, function returns all the current assets on the ledger');
			let result3 = await contract.evaluateTransaction('GetAllAssets');
